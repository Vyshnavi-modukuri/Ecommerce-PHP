    ...
    <?php while ($row = $result->fetch_assoc()): ?>
        <div class="menu-item">
            ...
            <?php if(isset($_SESSION['username'])): ?>
                <!-- Display "Add to Cart" and "Add to Wishlist" buttons if the user is signed in -->
                <form action="db.php" method="post">
                    <input type="hidden" name="productDescription" value="<?php echo $row["pdescript"]; ?>">
                    <input type="hidden" name="tableName" value="men">
            ...
            <?php else: ?>
                <!-- Display a message and a link to sign in when the user is not signed in -->
