...
<head>
    ...
    <style>
        ...
        .summary-table {
            ...
            .buy-btn {
                margin-top: 20px;
                margin-left:500px; /* Move the button to the right */
                padding: 15px 30px;
...
<body>
    ...
    <?php if ($result->num_rows > 0) : ?>
            ...
            <?php while ($row = $result->fetch_assoc()) : ?>
                <div class="menu-item">
                    ...
                    <form action="db.php" method="post">
                        ...
                        <button class="button" name="removeCart">Remove From Cart</button>
                    </form>
                </div>
            <?php endwhile; ?>
        </div>
        ...
        <div class="total-section">
            <strong>Total Price:</strong> $<?php echo $totalPrice; ?>
        </div>
        ...
        <table class="summary-table">
            ...
            <tr>
                ...
                <td>$99.00</td> <!-- Replace with your actual delivery charges -->
                <td>$<?php echo $totalPrice + 10 + 5; ?></td>
            </tr>
        </table>

        <!-- Buy button -->
        <a href="order.php"><button class="buy-btn">Proceed to Checkout</button></a>
    ...
    <?php else : ?>
        ...
        <div class="empty-cart-message empty-cart-container">
            Your cart is empty.
            <br><br> 
            <a href="index.php"><button class="button">Go Back for Shopping</button></a>
        </div>
    <?php endif; ?>
